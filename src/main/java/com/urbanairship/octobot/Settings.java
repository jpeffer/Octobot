 ...
 * as a standard map by calling Settings.get(OctobotConstants.OCTOBOT,
 * OctobotConstants.QUEUES).
...
public class Settings
{
    ...
    /**
     * Loads the Octobot configuration settings
     */
    ...
    private Settings()
    {
        ...
        {
            settingsFile = "/usr/local/octobot/octobot.yml";
        }

        try
        {
            configuration = (HashMap<String, HashMap<String, Object>>) YAML.load(new FileReader(settingsFile));
        }
        catch(Exception e)
        {
     ...
     * @param defaultValue
     *
     * @return Integer value of the input Object
     */
    public static Integer getIntFromYML(Object obj, Integer defaultValue)
    {
        ...
        {
            logger.info("Error reading setting. Value passed is not a valid number. Using default value: " + defaultValue);
        }
        catch(NullPointerException e)
        {
            logger.info("Error reading setting. Value passed was null. Using default value: " + defaultValue);
        }
     ...
     * @param key
     *
     * @return boolean value of the passed category/key pair
     */
